...
- (UILabel *)stateLabel
{
    if (!_stateLabel) {
        ...
        _stateLabel.textColor = MJRefreshColor(88, 89, 89);
...
- (UILabel *)lastUpdatedTimeLabel
{
    if (!_lastUpdatedTimeLabel) {
        ...
        _lastUpdatedTimeLabel.textColor = MJRefreshColor(156, 156, 156);
...
- (void)placeSubviews
{
    ...
    if (self.lastUpdatedTimeLabel.hidden) {
        ...
        if (self.lastUpdatedTimeLabel.constraints.count == 0) {
            ...
            self.lastUpdatedTimeLabel.mj_y = self.stateLabel.mj_h + 7;
            self.lastUpdatedTimeLabel.mj_w = self.mj_w;
            self.lastUpdatedTimeLabel.mj_h = 20;
        }
    }
}
